locals {
  ...
  predefined_rules = {
    "DenyInternetInBound" = {
      ...
      "source_address_prefixes"                    = local.service_tags.internet
      "destination_port_ranges"                    = local.entire_port_range
      "destination_address_prefixes"               = local.service_tags.virtualnetwork
    },
    "DenyInternetOutBound" = {
      ...
      "protocol"                                   = local.protocol.any
      "source_port_ranges"                         = local.entire_port_range
      "source_address_prefixes"                    = local.service_tags.virtualnetwork
      "destination_port_ranges"                    = local.entire_port_range
